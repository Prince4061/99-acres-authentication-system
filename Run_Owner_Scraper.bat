@echo off
echo ========================================================
echo Starting 99acres Owner Details Extractor...
echo ========================================================
echo.
...
echo The Owner Extractor Website should open automatically shortly.
echo.

:: Start the Flask app quietly in the background
start /B "" "%~dp0venv\Scripts\python.exe" "%~dp0app_owner.py" 
...
echo done extracting. Closing this will stop the server.
echo.
